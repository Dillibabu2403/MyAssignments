...
public class CreateOpportunityWithoutMandatoryFields extends BaseClassSalesForce {
	
	@DataProvider(name="CreateWithoutMandatory")
	public String[][] editLeads() throws IOException {
		String [] [] data=ReadExcelForCreateOppWithoutMandatory.read();
		return data;
	}
